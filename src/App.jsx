      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]  ">
          <div className="landing w-full h-screen bg-black">
            ...
            <div className="imagediv relative overflow-hidden w-full h-full">
              <img
              ...
              <img
                className="absolute character -top-0 -bottom-[50%] left-1/2  -translate-x-1  scale-[1]"
                src="./girlbg.png"
                alt=""
              />
            </div>
            <div className="btmbar text-white absolute bottom-1/2 left-0 w-full py-15 px-10 bg-gradient-to-t from-black to-transparent">
          ...
          <div className="w-full flex items-center justify-center px-10 h-screen bg-black">
